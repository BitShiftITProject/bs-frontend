...
class PublicPortfolio extends Component {
    ...
    getParams = () => {
        return {username:this.props.match.params.username, portfolio:this.props.match.params.portfolio, page:this.props.match.params.page};
    }    
        ...
        .then((user) => {
            ...
            // Otherwise we have a user so we need to get the portfolio
                ...
                if(user.portfolios.length > params.portfolio){
                    ...
                    return fetch(BACKEND + PORTFOLIOS + "/" + user.portfolios[params.portfolio])
    ...
    async componentDidMount() {
        ...
        // TODO: I think Dini has a better way of redirecting but idk how that works :(
        if(portfolio == null){
